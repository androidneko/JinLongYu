...
/**
 * Generated class for the PingEquipmentRecordsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-ping-equipment-records',
  templateUrl: 'ping-equipment-records.html',
})
export class PingEquipmentRecordsPage extends BasePage{
  param:any = {
    "loginName":"",
    "sessionId":"",
    "equipmentCode":"",
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PingEquipmentRecordsPage');
