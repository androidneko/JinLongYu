...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      LogU.d(TAG, "This device does supports control of a flashlight");
    } else {
    	LogU.d(TAG, "This device does not support control of a flashlight");
    }
  }
...
//      LogU.d(TAG, "Unexpected error while finding class " + name, re);
      return null;
    }
  }
...
//      LogU.d(TAG, "Unexpected error while finding method " + name, re);
      return null;
    }
  }
...
//      LogU.d(TAG, "Unexpected error while invoking " + method, e);
      return null;
    } catch (InvocationTargetException e) {
//      LogU.d(TAG, "Unexpected error while invoking " + method, e.getCause());
      return null;
    } catch (RuntimeException re) {
//      LogU.d(TAG, "Unexpected error while invoking " + method, re);
      return null;
    }
  }
