...
import com.androidcat.jly.application.JlHceApp;
import com.androidcat.jly.consts.GConfig;
import com.androidcat.jly.cordova.manager.TyPluginCoreWorker;
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                SharePreferencesUtil.setValue(SPConsts.JPUSH_ID, regId);
        ...
        if (title.equals("系统消息") || title.equals("微贷消息")|| title.equals("进销存消息")){
          final Intent eventIntent = new Intent("androidcat.nativeEvent");
          eventIntent.putExtra("eventName","pushMessage");
          eventIntent.putExtra("data",title);
          context.sendBroadcast(eventIntent);
        }

        Log.e("Amap", "sendBroadcastSync");
