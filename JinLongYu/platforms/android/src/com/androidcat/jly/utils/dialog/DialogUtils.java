package com.androidcat.jly.utils.dialog;
...
public class DialogUtils {
  ...
  public static Dialog getDownloadDialog(final Context context, String msg) {
    final Dialog dialog = new Dialog(context, R.style.normalDialog);
    if (null == dialog) {
      android.util.Log.d("cw_test", "getFirmwareDialog");
      return null;
    }

    dialog.setContentView(R.layout.upgrade_download_dialog);
